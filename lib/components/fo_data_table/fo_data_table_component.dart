...
class FoDataTableComponent implements OnChanges, OnInit, OnDestroy {
  ...
  final StreamController<int> onRowsChangeController = new StreamController();
  ...
  @Output('rowsChange')
  Stream<int> get onRowsChangeOutput => onRowsChangeController.stream;

  @Output('sort')
  Stream<Map<String, dynamic>> get onSortOutput =>
      _onSortController.stream; // = ((model) => null);
  ...
  void onRowClick(Object id) {
    if (!disabled) {
      onRowClickController.add(id);
    }
  }
