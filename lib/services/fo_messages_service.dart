...
class FoMessagesService {
  ...
  String comments(int howMany) => Intl.plural(howMany,
      one: 'comment', other: 'comments', args: [howMany], name: 'comments');
  ...
  String day(int howMany) => Intl.plural(howMany,
      one: 'day', other: 'days', args: [howMany], name: 'day');
  ...
  String enter_email() =>
      Intl.message('enter a valid email', name: 'enter_email');

  String enter_firstname() =>
      Intl.message('enter a firstname', name: 'enter_firstname');

  String enter_lastname() =>
      Intl.message('enter a lastname', name: 'enter_lastname');

  String enter_phone() =>
      Intl.message('enter a valid phone', name: 'enter_phone');
  ...
  String filter_enter() =>
      Intl.message('filter (press enter to apply)', name: 'filter_enter');
  ...
  String gdpr_erase_me() =>
      Intl.message('I wish to erase all my data', name: 'gdpr_erase_me');
  ...
  String issue(int howMany) => Intl.plural(howMany,
      one: 'issue', other: 'issues', args: [howMany], name: 'issue');
  ...
  String month(int howMany) => Intl.plural(howMany,
      one: 'month', other: 'months', args: [howMany], name: 'month');
  ...
  String year(int howMany) => Intl.plural(howMany,
      one: 'year', other: 'years', args: [howMany], name: 'year');
}
